  ...
  return (
    <header className="w-full bg-white/80 backdrop-blur-md border-b border-slate-200/80 px-6 py-4 flex items-center justify-between sticky top-0 z-40">
      <div className="flex items-center space-x-3">
        <div className="flex items-center justify-center w-10 h-10 rounded-xl bg-gradient-to-tr from-violet-600 to-indigo-500 text-white shadow-md shadow-violet-500/10">
          <ShopOutlined className="text-xl" />
        </div>
        <div>
          <h2 className="text-lg font-bold tracking-wide text-slate-900">MasBordados</h2>
          <p className="text-xs text-slate-500 font-medium">Bordados Industriales</p>
        </div>
      </div>
